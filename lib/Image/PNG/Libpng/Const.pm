package Image::PNG::Libpng::Const;
require Exporter;
@ISA = qw(Exporter);
@EXPORT_OK = qw/
PNG_DISPOSE_OP_NONE
...
Image::PNG::Libpng::Const

=head1 SYNOPSIS

       # Get the constants you need:
       use Image::PNG::Libpng::Const qw/PNG_TRANSFORM_INVERT_ALPHA
                               PNG_COLOR_MASK_ALPHA/;
       # Get everything:
...
=item PNG_DISPOSE_OP_NONE = 0x00

=item PNG_DISPOSE_OP_BACKGROUND = 0x01

=item PNG_DISPOSE_OP_PREVIOUS = 0x02

=item PNG_BLEND_OP_SOURCE = 0x00

=item PNG_BLEND_OP_OVER = 0x01
...
=item PNG_FP_1 = 100000

=item PNG_FP_HALF = 50000

=item PNG_FP_MIN = (-PNG_FP_MAX)
...
=item PNG_INFO_acTL = 0x10000

=item PNG_INFO_fcTL = 0x20000
...
=item PNG_TRANSFORM_EXPAND_16 = 0x4000

=item PNG_TRANSFORM_SCALE_16 = 0x8000
...
=item PNG_ERROR_ACTION_NONE = 1

=item PNG_ERROR_ACTION_WARN = 2

=item PNG_ERROR_ACTION_ERROR = 3

=item PNG_RGB_TO_GRAY_DEFAULT = (-1)

=item PNG_ALPHA_PNG = 0

=item PNG_ALPHA_STANDARD = 1

=item PNG_ALPHA_ASSOCIATED = 1

=item PNG_ALPHA_PREMULTIPLIED = 1

=item PNG_ALPHA_OPTIMIZED = 2

=item PNG_ALPHA_BROKEN = 3

=item PNG_DEFAULT_sRGB = -1

=item PNG_GAMMA_MAC_18 = -2

=item PNG_GAMMA_sRGB = 220000

=item PNG_GAMMA_LINEAR = 100000

=item PNG_READ_16_TO_8 = SUPPORTED

=item PNG_GAMMA_THRESHOLD = (PNG_GAMMA_THRESHOLD_FIXED*.00001)
...
=item PNG_INTERLACE_ADAM7_PASSES = 7
...
L<Image::PNG::Libpng> distribution. You need to have the L<Template> module
...
Image::PNG::Libpng distribution. Its name is C<Const.pm.tmpl>.
